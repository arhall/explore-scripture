...
class ModuleLoader {
      ...
      entries => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            ...
            if (
              target.classList.contains('scripture-ref') &&
              !this.loadedModules.has(this.moduleConfig['scripture-widget'])
            ) {
            ...
            if (
              target.classList.contains('read-chapter-btn') &&
              !this.loadedModules.has(this.moduleConfig['chapter-reader'])
            ) {
  ...
  observeElements(observer) {
    ...
    const observeWhenReady = () => {
      ...
      // Search containers
      document
        .querySelectorAll('[id*="search"], [class*="search"]')
