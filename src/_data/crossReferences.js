      ...
      references: [
        {
          ...
          text: "Abraham's promise fulfilled",
        },
      ...
      references: [
        {
          book: 'matthew',
          chapter: '27',
          connection: 'messianic',
          text: 'Crucifixion psalms quoted',
        },
    ...
    romans: {
      ...
      references: [
        { book: 'genesis', chapter: '15', connection: 'faith', text: "Abraham's righteousness" },
        {
          ...
          text: 'Blessed is he whose sin is covered',
        },
        {
          book: 'galatians',
          chapter: '3',
          connection: 'justification',
          text: 'Parallel teaching on faith',
        },
      ],
    },
  },
  ...
  chapterReferences: {
    'genesis-1': [
      ...
      },
      {
        ...
        chapter: '1',
        verse: '16',
        connection: 'Christ as Creator',
        text: 'All things created through him',
      },
      {
        book: 'hebrews',
        chapter: '1',
        verse: '2',
        connection: 'Son as Creator',
        text: 'Through whom he made the universe',
      },
      {
        book: 'revelation',
        chapter: '4',
        verse: '11',
        connection: 'Creation worship',
        text: 'You created all things',
      },
    ],
    'genesis-3': [
      {
        ...
        chapter: '5',
        verse: '12',
        connection: 'Sin enters world',
        text: 'Sin through one man',
      },
      {
        book: 'galatians',
        chapter: '3',
        verse: '15',
        connection: 'First promise',
        text: 'Promise to offspring',
      },
      {
        book: 'revelation',
        chapter: '20',
        verse: '2',
        connection: 'Satan defeated',
        text: 'Ancient serpent bound',
      },
    ],
    'genesis-12': [
      {
        ...
        chapter: '3',
        verse: '8',
        connection: 'Gospel preached',
        text: 'Scripture preached gospel to Abraham',
      },
      {
        book: 'romans',
        chapter: '4',
        verse: '16',
        connection: 'Promise by faith',
        text: 'Promise guaranteed to all offspring',
      },
      {
        book: 'hebrews',
        chapter: '11',
        verse: '8',
        connection: 'Faith example',
    ...
    'psalms-22': [
      ...
      },
      {
        ...
        chapter: '15',
        verse: '24',
        connection: 'Crucifixion details',
        text: 'They divided his garments',
      },
      {
        book: 'hebrews',
        chapter: '2',
    ...
    'isaiah-53': [
      {
        ...
        chapter: '8',
        verse: '17',
        connection: 'Healing ministry',
        text: 'He took our illnesses',
      },
      {
        book: 'acts',
        chapter: '8',
        verse: '32',
        connection: 'Ethiopian eunuch',
        text: 'Like a lamb led to slaughter',
      },
      {
        book: '1-peter',
        chapter: '2',
        ...
        text: 'By his wounds you have been healed',
      },
    ],
    'matthew-5': [
      {
        ...
        chapter: '6',
        verse: '20',
        connection: 'Parallel teaching',
        text: 'Blessed are you poor',
      },
      {
        book: 'james',
        chapter: '1',
        verse: '2',
        connection: 'Trials and joy',
        text: 'Consider it joy when you face trials',
      },
      {
        book: '1-peter',
        chapter: '3',
        verse: '14',
        connection: 'Suffering blessing',
        text: 'Blessed if you suffer for righteousness',
      },
    ],
    'john-3': [
      {
        ...
        text: 'If you confess with your mouth',
      },
      {
        book: 'ephesians',
        chapter: '2',
        verse: '8',
        connection: 'Grace salvation',
      ...
      },
      {
        ...
        chapter: '3',
        verse: '5',
        connection: 'New birth',
        text: 'Washing of regeneration',
      },
    ],
    'romans-8': [
      {
        ...
        chapter: '5',
        verse: '16',
        connection: 'Spirit vs flesh',
        text: 'Walk by the Spirit',
      },
      {
        book: 'ephesians',
        chapter: '1',
        verse: '13',
        connection: 'Holy Spirit seal',
        text: 'Sealed with promised Holy Spirit',
      },
      {
        book: '1-john',
        chapter: '3',
        verse: '1',
        connection: 'Children of God',
        text: 'See what kind of love the Father has given',
      },
    ],
  },
  ...
  thematicReferences: {
    covenant: [
      ...
      { book: '2-samuel', chapter: '7', connection: 'David', text: 'Eternal throne promise' },
      {
        book: 'jeremiah',
        chapter: '31',
        connection: 'New Covenant',
        text: 'New covenant promised',
      },
    ...
    messiah: [
      ...
      { book: 'psalms', chapter: '2', connection: 'Anointed King', text: 'You are my Son' },
      {
        ...
        chapter: '7',
        verse: '14',
        connection: 'Virgin birth',
        text: 'Virgin shall conceive',
      },
      {
        book: 'isaiah',
        chapter: '9',
        verse: '6',
        connection: 'Divine child',
        text: 'Child is born, Son is given',
      },
      {
        book: 'daniel',
        chapter: '7',
        verse: '13',
        connection: 'Son of Man',
        text: 'Like a son of man',
      },
      {
        book: 'matthew',
        chapter: '1',
        connection: 'Fulfillment',
        text: 'Genealogy of Jesus Christ',
      },
    ],
    salvation: [
      {
        ...
        chapter: '15',
        verse: '6',
        connection: 'Faith credited',
        text: 'Believed God, credited as righteousness',
      },
      {
        book: 'psalms',
        chapter: '32',
        verse: '1',
        connection: 'Forgiveness',
        text: 'Blessed whose sin is forgiven',
      },
      {
        book: 'isaiah',
        chapter: '55',
        verse: '7',
        connection: 'Call to repent',
        text: 'Let wicked forsake his way',
      },
      {
        book: 'john',
        chapter: '3',
        verse: '16',
        connection: "God's love",
    ...
    resurrection: [
      {
        ...
        verse: '10',
        connection: 'Prophecy',
        text: 'Will not abandon to Sheol',
      },
      {
        book: 'isaiah',
        chapter: '53',
        ...
        text: 'He will see his offspring',
      },
      { book: 'matthew', chapter: '28', connection: 'Historical event', text: 'He has risen' },
      {
        ...
        text: 'If Christ has not been raised',
      },
      {
        book: 'revelation',
        chapter: '1',
        verse: '18',
        connection: 'Victory',
        text: 'I died, and behold I am alive',
      },
    ],
    'second-coming': [
      {
        ...
        verse: '13',
        connection: 'Vision',
        text: 'Coming with clouds of heaven',
      },
      {
        book: 'matthew',
        chapter: '24',
        verse: '30',
        connection: "Jesus' teaching",
        text: 'Sign of Son of Man in heaven',
      },
      {
        book: 'acts',
        chapter: '1',
      ...
      },
      {
        ...
        verse: '16',
        connection: 'Rapture',
        text: 'Lord himself will descend',
      },
      {
        book: 'revelation',
        chapter: '19',
        verse: '11',
        connection: 'Return as King',
        text: 'Rider on white horse',
      },
    ],
  },
